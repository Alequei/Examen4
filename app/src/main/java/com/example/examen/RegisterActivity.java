...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tituloInput = findViewById(R.id.precio_input);
    ...
    public void callRegister(View view) {
        ...
        String solicitud = tituloInput.getText().toString();
        String detalles = detallesInput.getText().toString();

        if (nombre.isEmpty() || solicitud.isEmpty()) {
            Toast.makeText(this, "Nombre y y titulo son  campos  requeridos", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (mediaFileUri == null) {
            ...
            call = service.createMatricula(nombre,solicitud , detalles);
        } else {
            ...
            RequestBody precioPart = RequestBody.create(MultipartBody.FORM, solicitud);
            RequestBody detallesPart = RequestBody.create(MultipartBody.FORM, detalles);

            call = service.createMatriculaWithImage(nombrePart, precioPart, detallesPart, imagenPart);
        }
